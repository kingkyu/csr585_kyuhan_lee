...
for line in train_file:
	...
	try:
		...
		if (network_input[0]+network_input[1]) != 0 and (network_input[2]+network_input[3]) != 0:
			normalized_network_input = [network_input[0]/(network_input[0]+network_input[1]),network_input[1]/(network_input[0]+network_input[1]),network_input[2]/(network_input[2]+network_input[3]),network_input[3]/(network_input[2]+network_input[3])]
		else:
			normalized_network_input = [0,0,0,0]
...
result = open("result_network_fast_all_normalized_word2vec.txt", "w")
